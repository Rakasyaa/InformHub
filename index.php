            ...
            <div class="container">
                <div class="Home-content">
                    ...
                    <div class="Home-buttons">
                        <a href="<?php echo SITE_URL; ?>/pages/tutorial.php" class="btn btn-primary btn-lg me-3">
                ...
                <?php foreach ($latest_tutorials as $tutorial): ?>
                    <div class="col-md-4">
                        <div class="card course-card h-100">
                            <a href="<?php echo SITE_URL; ?>/pages/tutorial.php?id=<?php echo urlencode($tutorial['tutorial_id']); ?>">
                                <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <a href="forum.php" class="btn btn-outline-primary btn-sm">
                                    View All
                                </a>
                            </div>
